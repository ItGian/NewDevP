    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="Kita akan berkolaborasi untuk memetakan tujuan situs web Anda, target audiens, dan fungsi utama. Kita akan membahas hal-hal seperti struktur situs, navigasi, dan kebutuhan konten.Kita akan berkolaborasi untuk memetakan tujuan situs web Anda, target audiens, dan fungsi utama. Kita akan membahas hal-hal seperti struktur situs, navigasi, dan kebutuhan konten."
        ></Card>
        <Card
